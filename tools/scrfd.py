...
def parse_args():
    ...
    parser.add_argument('--kind', help='image/webcam',default='image')
    parser.add_argument('--path', type=str, help='Images for input' ,default='tests/data/me.jpeg')
    parser.add_argument('--webcam', type=int, help='index of webcam' ,default=0)
